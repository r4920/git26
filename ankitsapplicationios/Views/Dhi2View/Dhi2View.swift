...
struct Dhi2View: View {
    @StateObject var dhi2ViewModel = Dhi2ViewModel()
            ...
            VStack {
                    ...
                    VStack(alignment: .leading, spacing: 0) {
                        VStack(alignment: .leading, spacing: 0) {
                            ...
                            HStack {
                                ...
                                .shadow(color: ColorConstants.Black90008, radius: 14, x: 2, y: 0)
                        ...
                        .frame(width: UIScreen.main.bounds.width, height: getRelativeHeight(size: 590.0), alignment: .leading)
                        VStack {
                            ZStack(alignment: .leading) {
                                Text(StringConstants.kLblAdditions)
                                    ...
                                    .padding(.bottom, getRelativeHeight(size: 39.0))
                                    .padding(.trailing, getRelativeWidth(size: 202.0))
                                ZStack(alignment: .leading) {
                                    HStack {
                                        TextField(StringConstants.kLblJalapeno, text: $dhi2ViewModel.group37Text)
                                            .font(FontScheme.kPoppinsRegular(size: getRelativeHeight(size: 10.0)))
                                            .foregroundColor(ColorConstants.Gray700)
                                            .padding()
                                        Image("img_group_2")
                                    ...
                                    .frame(width: getRelativeWidth(size: 361.0), height: getRelativeHeight(size: 29.0), alignment: .center)
                                    .padding(.top, getRelativeHeight(size: 47.0))
                                    VStack(alignment: .leading, spacing: 0) {
                                        VStack(alignment: .leading, spacing: 0) {
                                            Text(StringConstants.kLblUser1)
                                                .font(FontScheme.kPoppinsRegular(size: getRelativeHeight(size: 16.0)))
                                                .foregroundColor(ColorConstants.Gray602)
                                                .minimumScaleFactor(0.5)
                                                .multilineTextAlignment(.leading)
                                                .frame(width: getRelativeWidth(size: 295.0), height: getRelativeHeight(size: 44.0), alignment: .leading)
                                        ...
                                        VStack {
                                            Divider()
                                                .frame(width: getRelativeWidth(size: 292.0), height: getRelativeHeight(size: 1.7), alignment: .center)
                                                .background(ColorConstants.WhiteA700)
                                                .padding(.horizontal, getRelativeWidth(size: 1.5))
                                        }
                                        .frame(width: getRelativeWidth(size: 295.0), height: getRelativeHeight(size: 1.7), alignment: .center)
                                        VStack(alignment: .leading, spacing: 0) {
                                            Text(StringConstants.kLblUser2)
                                                ...
                                                .padding(.leading, getRelativeWidth(size: 16.0))
                                                .onTapGesture {
                                                    dhi2ViewModel.nextScreen = "Dhi1View"
                                                }
                                        }
                                        .frame(width: getRelativeWidth(size: 295.0), height: getRelativeHeight(size: 44.0), alignment: .leading)
                                    }
                                    .frame(width: getRelativeWidth(size: 295.0), height: getRelativeHeight(size: 89.0), alignment: .leading)
                                    .background(RoundedCorners(topLeft: 18.0, topRight: 18.0, bottomLeft: 18.0, bottomRight: 18.0))
                                    .shadow(color: ColorConstants.Black9000d, radius: 14, x: 0, y: 4)
                                    .padding(.trailing, getRelativeWidth(size: 68.0))
                                }
                                .hideNavigationBar()
                                .frame(width: getRelativeWidth(size: 363.0), height: getRelativeHeight(size: 89.0), alignment: .leading)
                            }
                            .hideNavigationBar()
                            .frame(width: getRelativeWidth(size: 363.0), height: getRelativeHeight(size: 89.0), alignment: .center)
                                    ...
                                    ZStack(alignment: .trailing) {
                                        ...
                                        HStack {
                                            ...
                                            Text(StringConstants.kLbl2)
                                                ...
                                                .onTapGesture {
                                                    dhi2ViewModel.nextScreen = "Dhi4View"
                                                }
                                        }
                        ...
                        .frame(width: UIScreen.main.bounds.width, height: getRelativeHeight(size: 165.0), alignment: .center)
                        .padding(.top, getRelativeHeight(size: 5.0))
                    }
                ...
                Group {
                    NavigationLink(destination: Dhi1View(),
                                   tag: "Dhi1View",
                                   selection: $dhi2ViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct Dhi2View_Previews: PreviewProvider {
