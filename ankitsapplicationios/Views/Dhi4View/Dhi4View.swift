        ...
        NavigationView {
            VStack {
                VStack(alignment: .leading, spacing: 0) {
                        ...
                        ZStack(alignment: .bottomLeading) {
                            ZStack(alignment: .center) {
                                                    ...
                                                    ZStack(alignment: .bottomTrailing) {
                                                        ...
                                                        HStack {
                                                            ...
                                                            Text(StringConstants.kLbl30Min)
                                                                ...
                                                                .minimumScaleFactor(0.5)
                                                                .multilineTextAlignment(.leading)
                                                                .frame(width: getRelativeWidth(size: 39.0), height: getRelativeHeight(size: 10.5), alignment: .topLeading)
                                                                .padding(.leading, getRelativeWidth(size: 11.71))
                                                        }
                                                        .frame(width: getRelativeWidth(size: 102.0), height: getRelativeHeight(size: 12.75), alignment: .bottomTrailing)
                                ...
                                VStack(alignment: .leading, spacing: 0) {
                                    ...
                                    .frame(width: getRelativeWidth(size: 310.9), height: getRelativeHeight(size: 37.41), alignment: .leading)
                                    .shadow(color: ColorConstants.Black90040, radius: 6, x: 0, y: 1)
                                    .padding(.vertical, getRelativeHeight(size: 1.95))
                                }
                                .frame(width: getRelativeWidth(size: 310.9), height: getRelativeHeight(size: 61.65), alignment: .center)
                                .padding(.top, getRelativeHeight(size: 434.0))
                                .padding(.leading, getRelativeWidth(size: 47.55))
                                .padding(.trailing, getRelativeWidth(size: 55.55))
                            }
                            .hideNavigationBar()
                            .frame(width: UIScreen.main.bounds.width, height: getRelativeHeight(size: 506.0), alignment: .leading)
                            ZStack {}
                        ...
                        VStack(alignment: .leading, spacing: 0) {
                            VStack(alignment: .leading, spacing: 0) {
                                HStack {
                                    HStack {
                                        Text(StringConstants.kLblSelectUser)
                                            ...
                                            .minimumScaleFactor(0.5)
                                            .multilineTextAlignment(.leading)
                                            .frame(width: getRelativeWidth(size: 118.0), height: getRelativeHeight(size: 28.0), alignment: .topLeading)
                                        ...
                                        Text(StringConstants.kLblUser1)
                                            ...
                                            .minimumScaleFactor(0.5)
                                            .multilineTextAlignment(.leading)
                                            .frame(width: getRelativeWidth(size: 93.0), height: getRelativeHeight(size: 28.0), alignment: .topLeading)
                                ...
                                VStack {
                                    ...
                                    HStack {
                                        TextField(StringConstants.kLblJalapeno, text: $dhi4ViewModel.group51Text)
                                            .font(FontScheme.kPoppinsRegular(size: getRelativeHeight(size: 10.0)))
                                            .foregroundColor(ColorConstants.Gray700)
                                            .padding()
                                        Image("img_group_2")
                                    ...
                                    .frame(width: getRelativeWidth(size: 370.0), height: getRelativeHeight(size: 29.0), alignment: .leading)
                                    .padding(.leading, getRelativeWidth(size: 31.0))
                                        ...
                                        ZStack(alignment: .trailing) {
                                            ZStack(alignment: .bottomTrailing) {
                                                ...
                                                Text(StringConstants.kLbl22)
                                                    .font(FontScheme.kMetropolisSemiBold(size: getRelativeHeight(size: 21.0)))
                                                    .foregroundColor(ColorConstants.Gray50)
                                                    .minimumScaleFactor(0.5)
                                                    .multilineTextAlignment(.leading)
                                            ...
                                            HStack {
                                                Text(StringConstants.kLbl)
                                                    ...
                                                    .onTapGesture {
                                                        dhi4ViewModel.nextScreen = "DhiView"
                                                    }
                    ...
                    .background(ColorConstants.WhiteA700)
                    .shadow(color: ColorConstants.DeepOrangeA20026, radius: 30, x: 0, y: -3)
                }
