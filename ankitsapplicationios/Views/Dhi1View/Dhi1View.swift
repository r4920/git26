...
struct Dhi1View: View {
    @StateObject var dhi1ViewModel = Dhi1ViewModel()
            ...
            VStack {
                            ...
                            VStack(alignment: .leading, spacing: 0) {
                                HStack {
                                    ...
                                    ZStack(alignment: .trailing) {
                                        ...
                                        .hideNavigationBar()
                                        .onTapGesture {
                                            dhi1ViewModel.nextScreen = "Dhi2View"
                                        }
                                    ...
                                    Text(StringConstants.kLblEdit)
                                        ...
                                        .minimumScaleFactor(0.5)
                                        .multilineTextAlignment(.leading)
                                        .frame(width: getRelativeWidth(size: 25.0), height: getRelativeHeight(size: 15.0), alignment: .topLeading)
                                    ...
                                    Image("img_editedit_1")
                                        .resizable()
                                        .frame(width: getRelativeWidth(size: 15.0), height: getRelativeHeight(size: 14.0), alignment: .center)
                                        .scaledToFit()
                                        .clipped()
                                        .padding(.top, getRelativeHeight(size: 12.0))
                                        .padding(.bottom, getRelativeHeight(size: 8.0))
                                        .padding(.trailing, getRelativeWidth(size: 17.0))
                                }
                                ...
                                VStack {
                                    ...
                                    HStack {
                                        TextField(StringConstants.kLblJalapeno, text: $dhi1ViewModel.group24Text)
                                            .font(FontScheme.kPoppinsRegular(size: getRelativeHeight(size: 10.0)))
                                            .foregroundColor(ColorConstants.Gray700)
                                            .padding()
                                        Image("img_group_2")
                                        ...
                                        ZStack(alignment: .trailing) {
                                            ...
                                            HStack {
                                                ...
                                                Text(StringConstants.kLbl2)
                                                    ...
                                                    .onTapGesture {
                                                        dhi1ViewModel.nextScreen = "Dhi4View"
                                                    }
                                            }
                ...
                Group {
                    NavigationLink(destination: Dhi2View(),
                                   tag: "Dhi2View",
                                   selection: $dhi1ViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct Dhi1View_Previews: PreviewProvider {
